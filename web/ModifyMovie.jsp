<%-- 
    ...
    Created on : Apr 9, 2015, 5:25:11 PM
    Author     : zeb
--%>
...
<c:choose>
    ...
    <c:otherwise>
        ...
        <div class="container">
            <form class="form-horizontal" method="post" action="AdminModifyMovie">
                <!-- Text input-->

                <div class="form-group">
                    <label class="col-md-4 control-label" for="name">Current Name</label>  
                    <div class="col-md-4">
                        <input id="name" name="oldname" value="${EditMovie.getName()}" class="form-control input-md"  type="text" readOnly="true">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="name" name="name" value="${EditMovie.getName()}" class="form-control input-md" required="" type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="length" value="${EditMovie.getMovieLength()}" name="length" placeholder="(in minutes)" class="form-control input-md" type="text">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="poster" name="poster" value="${EditMovie.getPoster()}" placeholder="" class="form-control input-md" type="text">
