<%-- 
    Document   : moviesnowplaying
    Created on : Feb 27, 2015, 3:45:20 PM
    Author     : zeb
--%>
...
<div class="container">
    <h1 class="page-header" style="color:black">
        MOVIES <span class="page-header-emphasis" style="color:gold">NOW PLAYING</span>
    </h1>
        ...
        <div class="row">
            <div class="large-9 columns">
                <div class="filter-group">
                    ...
                    <form method="get" action="PlayingNowForward">
                ...
                <br>
                <div class="thisweek">
                <h2> <u> Movies Now Playing</u> </h2>
                <ul class="list-inline">

                    <c:forEach var="movie" items="${sessionScope.recent}">
